...
*//**
 * <br>
 * <b>功能：</b>Redis的应用基类，在配置文件中对Redis进行了配置，这里对注入的类进行调用方法即可<br>
...
public class BaseJedis {
	...
	private final static Logger logger = Logger.getLogger(BaseJedis.class);
	...
	*//**
	 ...
	 * @return 1：设置了过期时间 0：没有设置过期时间/不能设置过期时间
	 *//*
	public synchronized long expireAt(String key, int unixTimestamp) {
		if (key == null || key.equals("")) {
			return 0;
		}
	...
	*//**
	 ...
	 * @return 状态码
	 *//*
	public synchronized String trimList(String key, long start, long end) {
		if (key == null || key.equals("")) {
			return "-";
		}
		ShardedJedis shardedJedis = null;
	...
	*//**
	 ...
	 * @return
	 *//*
	public synchronized long countSet(String key) {
		if (key == null) {
			return 0;
		}
		ShardedJedis shardedJedis = null;
	...
	*//**
	 ...
	 * @return
	 *//*
	public synchronized boolean addSet(String key, int seconds, String... value) {
	...
	*//**
	 ...
	 * @return 判断值是否包含在set中
	 *//*
	public synchronized boolean containsInSet(String key, String value) {
		if (key == null || value == null) {
			return false;
		}
		ShardedJedis shardedJedis = null;
	...
	*//**
	 ...
	 * @return
	 *//*
	public synchronized boolean removeSetValue(String key, String... value) {
		ShardedJedis shardedJedis = null;
		try {
			shardedJedis = shardedJedisPool.getResource();
	...
	*//**
	 ...
	 * @return
	 *//*
	public synchronized int removeListValue(String key, List<String> values) {
	...
	*//**
	 ...
	 * @return
	 *//*
	public synchronized int removeListValue(String key, long count,
			List<String> values) {
		int result = 0;
	...
	*//**
	 ...
	 * @return
	 *//*
	public synchronized boolean removeListValue(String key, long count,
			String value) {
		ShardedJedis shardedJedis = null;
		try {
			shardedJedis = shardedJedisPool.getResource();
	...
	*//**
	 ...
	 * @return
	 *//*
	public synchronized List<String> rangeList(String key, long start, long end) {
		if (key == null || key.equals("")) {
			return null;
		}
		ShardedJedis shardedJedis = null;
	...
	*//**
	 ...
	 * @return
	 *//*
	public synchronized long countList(String key) {
		if (key == null) {
			return 0;
		}
		ShardedJedis shardedJedis = null;
	...
	*//**
	 ...
	 * @return
	 *//*
	public synchronized boolean addList(String key, int seconds,
			String... value) {
	...
	*//**
	 ...
	 * @return
	 *//*
	public synchronized boolean addList(String key, List<String> list) {
	...
	*//**
	 ...
	 * @return
	 *//*
	public synchronized boolean setHSet(String domain, String key, String value) {
		if (value == null)
			return false;
		ShardedJedis shardedJedis = null;
		try {
	...
	*//**
	 ...
	 *//*
	public synchronized String getHSet(String domain, String key) {
		ShardedJedis shardedJedis = null;
		try {
			shardedJedis = shardedJedisPool.getResource();
	...
	*//**
	 ...
	 * @return 删除的记录数
	 *//*
	public synchronized long delHSet(String domain, String key) {
		ShardedJedis shardedJedis = null;
		long count = 0;
		try {
			shardedJedis = shardedJedisPool.getResource();
	...
	*//**
	 ...
	 * @return
	 *//*
	public synchronized boolean existsHSet(String domain, String key) {
		ShardedJedis shardedJedis = null;
	...
	*//**
	 ...
	 * @return
	 *//*
	public synchronized List<Map.Entry<String, String>> scanHSet(String domain,
			String match) {
		ShardedJedis shardedJedis = null;
		try {
			int cursor = 0;
	...
	*//**
	...
	public synchronized List<String> hvals(String domain) {
		ShardedJedis shardedJedis = null;
	...
	*//**
	...
	public synchronized Set<String> hkeys(String domain) {
		ShardedJedis shardedJedis = null;
	...
	*//**
	 ...
	 * @return
	 *//*
	public synchronized long lenHset(String domain) {
		ShardedJedis shardedJedis = null;
		long retList = 0;
		try {
			shardedJedis = shardedJedisPool.getResource();
	...
	*//**
	 ...
	 * @return
	 *//*
	public synchronized boolean setSortedSet(String key, long score,
			String value) {
		ShardedJedis shardedJedis = null;
		try {
			shardedJedis = shardedJedisPool.getResource();
	...
	*//**
	 ...
	 * @return
	 *//*
	public synchronized Set<String> getSoredSet(String key, long startScore,
	...
	*//**
	 ...
	 * @return
	 *//*
	public synchronized long countSoredSet(String key, long startScore,
			long endScore) {
		ShardedJedis shardedJedis = null;
		try {
			shardedJedis = shardedJedisPool.getResource();
	...
	*//**
	 ...
	 * @return
	 *//*
	public synchronized boolean delSortedSet(String key, String value) {
		ShardedJedis shardedJedis = null;
		try {
			shardedJedis = shardedJedisPool.getResource();
	...
	*//**
	 ...
	 * @return
	 *//*
	public synchronized Set<String> getSoredSetByRange(String key,
			int startRange, int endRange, boolean orderByDesc) {
		ShardedJedis shardedJedis = null;
		try {
			shardedJedis = shardedJedisPool.getResource();
			if (orderByDesc) {
	...
	*//**
	 ...
	 * @return
	 *//*
	public synchronized Double getScore(String key, String member) {
		ShardedJedis shardedJedis = null;
		try {
			shardedJedis = shardedJedisPool.getResource();
	...
	public synchronized boolean set(String key, String value, int second) {
		ShardedJedis shardedJedis = null;
		try {
			shardedJedis = shardedJedisPool.getResource();
