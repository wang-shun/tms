...
define(function (require, exports, module) {
    ...
    var Action = {
        ...
        waybillTrack: function (id, status) {
            ...
            window.location.href = "../tmsTransport/waybillTransportDetail.html?id=" + id;
        },
    ...
    $(document).ready(function () {
            ...
            colModel: [
                {
                    ...
                    search: false,
                    align: 'center',
                    formatter: DataFommater.gotoTransDetl
                },
                {
                    name: 'no',
                    index: 'no',
                    ...
                    search: false,
                    align: 'center',
                    formatter: DataFommater.showModal
                },
                {
                    name: 'orderNo',
                    index: 'orderNo',
                ...
                },
                {
                    ...
                    formatter: DataFommater.statusFormatter
                },
                {
                    name: 'scanStatus',
                    index: 'scanStatus',
                    ...
                    search: false,
                    align: 'center',
                    formatter: DataFommater.scanStatusFormatter
                },
                {
                    name: 'dName',
                    index: 'dName',
        ...
        $(grid_selector).jqGrid('navGrid', pager_selector,
            ...
            onClickButton: function () {
                publicUpdate.cancelOrConfirmData(grid_selector, "确认作废？", "../../yimiWaybill/oper", "delete", "运单作废成功");
            },
            position: "first"
        });
            ...
            switch (target.id) {
                ...
                case "waybillCancel":
                    publicUpdate.cancelOrConfirmData(
                        grid_selector, "确认作废？", "../../yimiWaybill/oper", "delete", "运单作废成功");
                    return;
                case "print":
                    Action.print();
                    return;
